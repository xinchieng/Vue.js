    ...
    <div class="container mb-5">
      ...
      <div class="row">
        <div class="col-lg-4 col-sm-6">
          ...
          <base-input placeholder="Search" addon-left-icon="ni ni-zoom-split-in">
          </base-input>
        </div>
        <div class="col-lg-4 col-sm-6">
          <base-input placeholder="Regular" disabled> </base-input>
          <base-input placeholder="Birthday" addon-right-icon="ni ni-zoom-split-in">
          </base-input>
        </div>
        <div class="col-lg-4 col-sm-6">
    ...
    <div class="py-5 bg-secondary">
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-6">
            <base-input alternative placeholder="Regular" disabled> </base-input>
            <base-input
              alternative
          ...
          <div class="col-lg-4 col-sm-6">
            ...
            <base-input alternative placeholder="Success" :valid="false"> </base-input>
          </div>
        </div>
      </div>
    </div>
